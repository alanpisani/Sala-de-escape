...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Bangers|Cutive+Mono&display=swap" rel="stylesheet"><link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.1/css/all.min.css'>
...
<input  type="text" name="caja" id="caja_valor"--> <!--INPUT DE TIPO TEXT QUE CONTENDRÁ EL VALOR DEL TIEMPO CONSEGUIDO. SE AGREGA ESE DATO POR SI SOLO MEDIANTE UNA FUNCION EN JS-->
<!--input disabled id="entrar-ranking"name="guardar-tiempo"type="submit" value="Guardar tiempo"--> <!--BOTON DESACTIVADO. SE ACTIVA MEDIANTE UNA FUNCION EN JS-->
<!--/form-->
<!--?php
...
<div id="puzzlerModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div id="puzzler-container">
      ...
      <p class="quote"></p>“Locura es hacer lo mismo una y otra vez esperando obtener resultados diferentes.”  -Albert Einstein<br>
      <p class="quote">Indicaciones: Ordená las frases de forma correcta si querés abrir este candado!<br>¿Lo lograrás a tiempo?</br><span class="bighint">Pista: </span><span class="revealtext">La respuesta se encuentra en el espejo! ¿Ya resolviste ese juego?</span> </p>
...
<div id="mirrorPuzzleModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div id="mirror-puzzle-container">
      ...
      <div id="note">
        <p id="note-text" class="mirror-text">"Transformando el futuro con educación de calidad, innovación tecnológica, aprendizaje significativo y formación integral."</p>
      </div>
      <div id="mmirror"></div>
...
<div id="recursionPuzzleModal" class="modal">
  ...
  <div v-if="won" class="won">
    <h1>Vamos! lo encontraste en el nivel {{details.level}} despues de {{details.clicks}} clicks y {{details.opened}} contenedores abiertos!</h1>
    <h1><i class="fa fa-ice-cream"></i></h1>
  </div>
  <thing v-else :data="root" :cb="cb"></thing>
</div>
...
<path stroke="brown" id="desk" class="st0" d="M130.4,65.4v5.5h2v33.7h5.5V73H207v6.4v1.3v8.4v1.4v14.1h18.3V90.5v-1.4v-8.4v-1.3v-8.5v-1.3v-4.3
...
<rect id="puzzlerBtn" x="120.4" y="11" class="st2" width="5.1" height="5" />               <!--Son las ubicaciones de los minijuegos-->
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.4/utils/Draggable.min.js'></script><script  src="js//script.js"></script>
